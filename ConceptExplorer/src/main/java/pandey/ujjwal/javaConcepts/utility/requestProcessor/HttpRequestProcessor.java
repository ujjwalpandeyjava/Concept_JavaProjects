package pandey.ujjwal.javaConcepts.utility.requestProcessor;
/* 
...
public class HttpRequestProcessor {
	...
	public static void main(String[] args) {
		...
		System.out.println(System.getenv().getOrDefault("SSL_CERTIFICATE_FILE_PATH", "SSL_CERTIFICATE_FILE_PATH: __"));
		// Set manually or use file path system
		// System.out.println(System.getenv().getOrDefault("TEMP", "NF")); // Working as
		// it is already set.
