package pandey.ujjwal.concepts.dbExample;

import java.util.List;
import java.util.Scanner;

import pandey.ujjwal.concepts.dbExample.dao.StudentDao;
import pandey.ujjwal.concepts.dbExample.dao.StudentDaoImpl;
