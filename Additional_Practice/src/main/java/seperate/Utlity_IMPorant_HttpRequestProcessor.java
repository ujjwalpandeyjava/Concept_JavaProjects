package com.safetylabs.org.util;
...
public class HttpRequestProcessor {
	...
	public static String sendHttpRequest(String urlWithParam, String reqMethod, String authHeader)
	{
		...
		try
		{
			...
			if(authHeader != null && authHeader.length() > 0) con.setRequestProperty("Authorization", authHeader);
			...
			else Log.error("Request cannot be processed successfully. Returned http response code=>%d", responseCode);
		}
		catch(Exception e)
		{
	 ...
	 * @throws IOException 
	 **/
	public static String sendHttpRequestWithJson(String url, String jsonText, String requestMethod, String authHeader) throws IOException
	{
		StringBuffer response = new StringBuffer();
		URL obj = new URL(url);
		HttpURLConnection con = (HttpURLConnection) obj.openConnection();
	 ...
	 * @throws IOException
	 */
	public static String sendHttpsRequestWithJson(String url, String jsonText, String requestMethod, String authHeader, boolean isReqWithCert, Properties headers) throws IOException
	{
		URL obj = new URL(url);
		...
		SSLSocketFactory sslSocketFactory = (isReqWithCert) ? createSSLSocketFactoryWithCert() : createSSLSocketFactory();			
	 ...
	 * @return
	 */
	public static String sendHttpsRequest(String url, String reqMethod, String authHeader, String contentType, boolean isReqWithCert, Properties headers){
		StringBuffer response = new StringBuffer();
		try
		{
		    ...
		    con.setSSLSocketFactory(sslSocketFactory);	
		    if(contentType != null && contentType.length() > 0) con.setRequestProperty("Content-Type", contentType);
	 ...
	 * @return
	 */
	public static InputStream sendHttpsRequestAndGetInputStream(String url, String reqMethod, String authHeader, String contentType, boolean isReqWithCert, Properties headers){
		try
		{
			URL obj = new URL(url);
	...
	/**
	 * This function is responsible to send HTTPS request with parameters
	 * @param url
	 * @param params
	 * @param reqMethod (POST/GET/PUT/DELETE)
	 * @param authHeader (Optional)
	 ...
	 * @return
	 */
	public static String sendHttpsRequest(String url, String params, String reqMethod, String authHeader, String contentType, boolean isReqWithCert, Properties headers){
		StringBuffer response = new StringBuffer();
		try
		{
			URL obj = new URL(url);
	...
	/**
	 * Function to Create SSLSocketFactory instance for secure https connection
	 **/
	...
	public static SSLSocketFactory createSSLSocketFactoryWithCert(){
		try 
		{
			String certPath = CommonUtility.readPropertyKey(Constants.PROPERTY_FILE_PATH + "safetylabs.properties", "SSL_CERTIFICATE_FILE_PATH");
