...
// It is for diagonal printing
	...
	{  for(int j=0;j<num;j++)
		{  if(i==j)
			{for(int l=0;l<i;l++)
			{System.out.print("  ");}      //we can also reduce {} form here which give the error advantage   
		     System.out.print(mat[i][j] +"");}// print 1st line according to loop and 2nd line once.
		}System.out.println();
	}	
//It is for sum of individual rows and columns.
	...
	{ 
		...
		{
			 sum1+=mat[i][j];
		} System.out.println("Sum of colummn " +(i+1) +" is "+sum1);sum1=0;		  
	}	
