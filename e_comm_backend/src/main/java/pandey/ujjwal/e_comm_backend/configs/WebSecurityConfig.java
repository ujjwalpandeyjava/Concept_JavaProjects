...
public class WebSecurityConfig {
	...
	@Autowired
	private PasswordEncoder passworeEncoder;
...
//					form.loginPage("/loginPage");	// set custom login page
	...
	public UserDetailsService hardCodedUsers() {
		UserDetails admin = org.springframework.security.core.userdetails.User
				...
				.password(passworeEncoder.encode(UserTypes.ADMIN.getUserPassword()))
		...
		UserDetails simple = org.springframework.security.core.userdetails.User
				...
				.password(passworeEncoder.encode(UserTypes.SIMPLE.getUserPassword()))
				.roles(UserTypes.SIMPLE.getRole(), UserTypes.USER.getRole()).build();
